...
const createAddPointFormTemplate = (localPoint) => {
  const { basePrice, dateFrom, dateTo, destination, offers, type } = localPoint;
...
export default class AddPointFormView {
  ...
  getTemplate() {
    return createAddPointFormTemplate(this.localPoint);
  }
